...
def get_parser():
    ...
    parser.add_argument('--max_epoch', default=14, help='epoch to train the network')
    parser.add_argument('--img_size', default=(94, 24), help='the image size')
    # parser.add_argument('--train_img_dirs', default="data/test", help='the train images path')
    parser.add_argument('--train_img_dirs', default="data/预训练/train", help='the train images path')
    parser.add_argument('--test_img_dirs', default="data/test", help='the test images path')
    parser.add_argument('--dropout_rate', default=0.5, help='dropout rate.')
    parser.add_argument('--learning_rate', default=0.1, help='base value of learning rate.')
    parser.add_argument('--lpr_max_len', default=8, help='license plate number max length.')
    parser.add_argument('--train_batch_size', default=200, help='training batch size.')
    ...
    parser.add_argument('--pretrained_model', default='./weights/Pre_LPRNet_model.pth', help='pretrained base model')
...
def train():
    ...
    optimizer = optim.RMSprop(lprnet.container.parameters(), lr=args.learning_rate, alpha=0.9, eps=1e-08,
                              momentum=args.momentum, weight_decay=args.weight_decay)
    print([name for name in lprnet.backbone.named_parameters()])
